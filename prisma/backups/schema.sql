...
COMMENT ON COLUMN "pub"."chat_hub_agents"."tools" IS 'Tools available to the agent as JSON node definitions';
...
COMMENT ON COLUMN "pub"."chat_hub_sessions"."tools" IS 'Tools available to the agent as JSON node definitions';
...
CREATE INDEX "IDX_99b3e329d13b7bb2fa9b6a43f5" ON "pub"."dynamic_credential_entry" USING "btree" ("subject_id");
...
CREATE INDEX "IDX_d57808fe08b77464f6a88a2549" ON "pub"."dynamic_credential_entry" USING "btree" ("resolver_id");
...
ALTER TABLE ONLY "pub"."workflow_publish_history"
    ADD CONSTRAINT "FK_b4cfbc7556d07f36ca177f5e473" FOREIGN KEY ("versionId") REFERENCES "pub"."workflow_history"("versionId") ON DELETE CASCADE;
...
ALTER TABLE ONLY "pub"."dynamic_credential_entry"
    ADD CONSTRAINT "FK_d57808fe08b77464f6a88a25494" FOREIGN KEY ("resolver_id") REFERENCES "pub"."dynamic_credential_resolver"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "pub"."dynamic_credential_entry"
    ADD CONSTRAINT "FK_e97db563e505ae5f57ca33ef221" FOREIGN KEY ("credential_id") REFERENCES "pub"."credentials_entity"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "pub"."workflow_statistics"
    ADD CONSTRAINT "fk_workflow_statistics_workflow_id" FOREIGN KEY ("workflowId") REFERENCES "pub"."workflow_entity"("id") ON DELETE CASCADE;
